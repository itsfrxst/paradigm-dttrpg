...
// (Campaign has its own full-viewport header, so it gets a FloatingMenuButton
// instead — this bar would fight its internal height math).
// `items` defaults to the full extension-build list; the mobile Artifact
// build passes a trimmed array instead (see AppMobile.jsx).
const NavBar = ({ current, onNavigate, onMenu, items=NAV_ITEMS }) => (
